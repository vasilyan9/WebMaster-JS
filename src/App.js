...
import GniHashvarkWebKayq from './components/Menu/GniHashvark/Link/GniHashvarkWebKayq/GniHashvarkWebKayq';
import GniHashvarkSeo from './components/Menu/GniHashvark/Link/GniHashvarkSeo/GniHashvarkSeo';
import GniHashvarkDizayn from './components/Menu/GniHashvark/Link/GniHashvarkDizayn/GniHashvarkDizayn';
import GniHashvarkGovazd from './components/Menu/GniHashvark/Link/GniHashvarkGovazd/GniHashvarkGovazd';
import Paymanagrer from './components/Menu/GniHashvark/Link/Paymanagrer/Paymanagrer';
    ...
    return ( 
        <BrowserRouter>
            ...
            <Switch>
                ...
                <Route path="/gni_hashark/paymanagrer" component={Paymanagrer} exact/>
